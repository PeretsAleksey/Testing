...
<div align="center"><h4>
    <c:if test="${requestScope.status eq true}">
        ...
        <form action="controller" method="post">
            <div align="center">
                <input type="hidden" name="command" value="getUsers"><br>
                <input type="submit" class="btn btn-default" value="<fmt:message key="u_page"/>">
            </div>
        </form>
    </c:if>
    ...
    <c:if test="${requestScope.type eq 'theme'}">
        ...
        <form action="controller" method="post">
            <div align="center">
                ...
                <input type="submit" class="btn btn-default" value="<fmt:message key="all_homepage"/>">
            </div>
        </form>
    </c:if>
    <c:if test="${requestScope.type eq 'test'}">
        ...
        <form action="controller" method="post">
            <div align="center">
                <input type="hidden" name="command" value="editTest"><br>
                <input type="submit" class="btn btn-default" value="<fmt:message key="tests_page"/>">
            </div>
        </form>
    </c:if>
        ...
        <form action="controller" method="post">
            <div align="center">
                <input type="hidden" name="command" value="editTest"><br> <input
                    type="submit" class="btn btn-default" value="<fmt:message key="tests_page"/>">
            </div>
        </form>
    </c:if>
    <c:if test="${requestScope.type eq 'addAnswer'}">
        ...
        <form action="controller" method="post">
            <div align="center">
                <input type="hidden" name="command" value="editQuestion"><br>
                <input type="submit" class="btn btn-default" value="<fmt:message key="questions_page"/>">
            </div>
        </form>
    </c:if>
    ...
    <c:if test="${requestScope.type eq 'addTest'}">
        ...
        <form action="controller" method="post">
            <div align="center">
                <input type="hidden" name="command" value="getTests"><br>
                <input type="submit" class="btn btn-default" value="<fmt:message key="tests_page"/>">
            </div>
        </form>
    </c:if>
    ...
    <c:if test="${requestScope.type eq 'deleteAnswer'}">
        ...
        <form action="controller" method="post">
            <div align="center">
                <input type="hidden" name="command" value="editQuestion"><br>
                <input type="submit" class="btn btn-default" value="<fmt:message key="answers_page"/>">
            </div>
        </form>
    </c:if>
