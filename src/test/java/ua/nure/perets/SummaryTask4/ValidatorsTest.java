...
public class ValidatorsTest {
    ...
    public void testValidateOnlyLatinFields(){
        ...
        Assert.assertEquals(FIELD + "sentence" + INVALID_SYMBOLS,Validators.validateOnlyLatinFields("☺☺☺", "sentence", 10));
        Assert.assertEquals(FIELD + "sentence" + INVALID_SYMBOLS,Validators.validateOnlyLatinFields("☺hggh", "sentence", 10));
    }
    @Test
